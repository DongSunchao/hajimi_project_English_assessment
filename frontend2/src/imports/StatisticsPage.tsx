...
import svgPaths from "./svg-1r2naedp1r";
import imgStatisticsPage from "figma:asset/ece298d0ec2c16f10310d45724b276a6035cb503.png";
...
type StatisticsPageTextAutoHeightBackgroundImageProps = {
  additionalClassNames?: string;
};

function StatisticsPageTextAutoHeightBackgroundImage({ children, additionalClassNames = "" }: React.PropsWithChildren<StatisticsPageTextAutoHeightBackgroundImageProps>) {
  return (
...
function BackgroundImage() {
  return (
    <div aria-hidden="true" className="absolute inset-0 pointer-events-none">
      ...
      <img alt="" className="absolute max-w-none object-cover opacity-20 size-full" src={imgStatisticsPage} />
    </div>
  );
}
...
export default function StatisticsPage() {
  return (
    <div className="relative size-full" data-name="Statistics Page">
      <BackgroundImage />
      ...
      <StatisticsPageTextAutoHeightBackgroundImage additionalClassNames="top-[342px]">
      ...
      </StatisticsPageTextAutoHeightBackgroundImage>
      <StatisticsPageTextAutoHeightBackgroundImage additionalClassNames="top-[192px]">
      ...
      <div className="-translate-x-1/2 absolute bg-[rgba(255,255,255,0.6)] content-stretch flex gap-[200px] items-center justify-center left-1/2 px-[30px] py-[10px] top-0 w-[1440px]" data-name="Header">
        ...
        <div className="bg-white relative rounded-[5px] shrink-0 w-[586px]" data-name="Header">
          <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
            <div className="content-stretch flex gap-[20px] items-center px-[10px] py-[5px] relative w-full">
              <BackgroundImage2>
                <Icon className="relative shrink-0 size-[16px]" isNumber="Empty" type="Pause" />
                <BackgroundImage5>Welcome</BackgroundImage5>
              </BackgroundImage2>
              <BackgroundImage2>
                <Icon className="relative shrink-0 size-[16px]" isNumber="off" type="Mic" />
                <BackgroundImage5>Practice</BackgroundImage5>
              </BackgroundImage2>
              <BackgroundImage2>
                <Icon className="relative shrink-0 size-[16px]" type="Statistics" />
                <BackgroundImage5>Statistics</BackgroundImage5>
              </BackgroundImage2>
              <ButtonIconTextHorizontalBackgroundImageAndText text="Logout" />
              <ButtonIconTextHorizontalBackgroundImageAndText text="Logout" />
            </div>
